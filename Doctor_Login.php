...
?>
    ...
    background-color: #f3f3f3;">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p style="text-align:center">From Hospital Administration? <a href="HospitalLogin.php">Login Here</a></a>.</p>
            <p style="text-align:center">Don't have an account? Please get in touch your administrator. </p>
        </form>
    </div>
</body>
</html>