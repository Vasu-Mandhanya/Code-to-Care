...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT Hospital_ID, Password FROM hospital WHERE Hospital_id = ? ;";
...
?>
    ...
    background-color: #f3f3f3;">
        <h2 style="text-align:center">Hospital Login</h2><br>
        <p class="textCenter">Please fill in your credentials to login.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p style="text-align:center">Don't have an account? <a href="hospitalSignUp.php">Sign up now</a>.</p>
        </form>
    </div>
